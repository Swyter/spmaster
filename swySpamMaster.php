...
$wgHooks['AbortNewAccount'][] = function( $user, &$message )
{
  ...
  */
   ...
   (spmatch('/[^aeiouy\s\d]{4,}/' )>=0  or
    spmatch('/[^aeiouy\s\d]{3}/'  )>=1)
